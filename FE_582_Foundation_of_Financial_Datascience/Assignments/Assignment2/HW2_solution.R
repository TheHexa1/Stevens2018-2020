...
plot(predPiecewise ~ age20to80,
     ...
     main= "Loess Curves Fitted to Run Time vs. Age for female")
...
plot(density(age2010, na.rm = TRUE), 
     ...
     main = "Density Curves for the Age of Female Runners")
...
plot(mR.lo.pr01 ~ age20to80,
     ...
     main=" Loess Curves Fit to Performance for female")
...
plot(gap12 ~ age20to80, type = "l" , xlab = "Age (years)", 
     ...
     main="Difference between Loess Curves for female")
...
plot(predPiecewise ~ age20to80,
     type = "l", col = "purple", lwd = 3,
     xlab = "Age (years)", ylab = "Run Time Prediction",
     main="Loess Curves Fitted for male runners")
...
plot(numRunners ~ names(numRunners), type="l", lwd = 2,
     xlab = "Years", ylab = "Number of Runners",
     main="the Number of Male Runners by Year")
...
plot(density(age2010, na.rm = TRUE), 
     ylim = c(0, 0.05), col = "purple",
     lwd = 3,  xlab = "Age (years)",  
     main = "Density Curves for the Age of Male Runners")
...
plot(mR.lo.pr01 ~ age20to80,
     type = "l", col = "purple", lwd = 3,
     xlab = "Age (years)", ylab = "Fitted Run Time (minutes)",
     main="Loess Curves Fit to Performance for male")
...
plot(gap12 ~ age20to80, type = "l" , xlab = "Age (years)", 
     ylab = "Difference in Fitted Curves (minutes)", lwd = 2,
     main="Difference between Loess Curves for male")


## Perform comparative analysis of the performance of the male runners 
## (previously analyzed in class) and female runners for the yearly data that you selected


# 1. From Age by Year plot: For female runners, majority of runners fall into age
# range of 28 - 40 years. For male runners, majority of runners fall into age range of
# 30 - 45 years

# 2. From density plot for the age: There are more Female runner participants
# around age of 30 years as compared to male runners of same age

# 3. From runtime vs age plot: Female runners between age range of 20-50 take more
# time to finish the race then male runners between same age range

# 4. From number of runners plot: Number of female runners are more than
# male runners for given years(2010,2011,2012)
